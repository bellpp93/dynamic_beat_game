...
//			}
		...
		g.drawImage(blueFlareImage, 150, 250, null);
		g.drawImage(judgeImage, 520, 410, null);
...
//			blueFlareImage = new ImageIcon(Main.class.getResource("../images/bludFlare.png")).getImage();
//		}
